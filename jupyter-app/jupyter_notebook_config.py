...
#  Default: ''
# Password is kish
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$mvwIY5kWGcz1c8xTJfkTwg$wD2FhWvtG1KYuQ81Y+hoew'
...
#  Choices: any of ['sha224', 'blake2s', 'sha1', 'md5', 'sha384', 'sha256', 'sha512', 'sha3_512', 'sha3_384', 'blake2b', 'sha3_224', 'sha3_256']
#  Default: 'sha256'
